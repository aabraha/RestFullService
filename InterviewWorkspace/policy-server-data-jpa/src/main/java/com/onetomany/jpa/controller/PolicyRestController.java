...
public class PolicyRestController {
	...
	public List<PolicyObj> getPolicies(){
		...
		System.err.println("Inside get all service");
	...
	// end point for GET "/policies/{policyId}/birthDate"
	@GetMapping("/policies/{policyNumber}/:birthDate")
	public List<PolicyObj> getResult(@PathVariable int policyNumber, 
									@RequestParam("birthDate") @DateTimeFormat(
											iso = DateTimeFormat.ISO.DATE) LocalDate birthDate) {
		
		System.err.println("At Named Query: " + birthDate);
		return policyRepository.findByPolicyNumberAndBirthDate(policyNumber, birthDate);
	}
